<?php
    ...
    class Film {
        ...
        public function get_film_poster($film_id) {
            $req = $this->db->prepare('SELECT * from images 
                                        WHERE images.film_id=:film_id 
                                        AND type="poster"
                                        LIMIT 1');
            $req->bindParam(':film_id', $film_id);
            return $req;
        ...
        public function get_film_couverture($film_id) {
            $req = $this->db->prepare('SELECT * from images 
                                        WHERE images.film_id=:film_id 
                                        AND type="couverture"
                                        LIMIT 1');
        ...
        public function get_film_video($film_id) {
            $req = $this->db->prepare('SELECT * from videos 
                                        WHERE videos.film_id=:film_id 
                                        AND type="video"
                                        LIMIT 1');
            $req->bindParam(':film_id', $film_id);
            return $req;
